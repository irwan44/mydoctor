...
class _TindakanDokterObatState extends State<TindakanDokterObat> {
  ...
  Map<dynamic, dynamic> _selectedItemUserTindakan1 = {
    "act" : "get_jenis_obat"
  };
  Map<dynamic, dynamic> _selectedItemUserTindakan2 = {
  ...
  Map<dynamic, dynamic> _selectedItemUser = {"kode_obat": "-", "nama_obat": "-"};
  ...
  Future<void> _getFirtsInfoTindakan() async {
    ...
    var response = await Dio().get(
      ...
      queryParameters: { "act" : "get_aturan_pakai",
        "id_kesediaan_obat" : "9"},
...
//     }
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Expanded(
                                              child: ListComboItemKelompok(context, dataSoap)),
                                        ],
                                      )),
                                ),
                                Padding(
  ...
  Widget bottomnavbar(PeriksaPasienProfile item) {
  ...
  @override
  Widget ListComboItemKelompok(BuildContext context, List<Map<dynamic, dynamic>> item) {
    return FutureBuilder<List<AntrianPasienProfile>>(
        ...
        builder: (context, _) => Container(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            ...
            return Container(
              child: Padding(
                  padding:
                  const EdgeInsets.only(top: 1.0, bottom: 1, right: 1, left: 10),
                  child: Padding(
  ...
  Future<void> _getfillICD10() async {
    try {
      ...
      setState(() {
        ...
        _selectedICD10['jumlah_stok'] =
            _selectedItemUser['jumlah_stok'] + ',' + _selectedItemUser['jumlah_stok'];
  ...
  Future<void> _getSearchInfo() async {
    ...
    try {
      ...
      var response = await Dio().get(url.toString(),
          queryParameters: {"act": "get_nama_obat", "$kode_bagian_far" : "", "src_obat": _hasBeenPressed});
